...
export const register = (name, surname, email, password, address, phone) => async(dispatch) =>{
    dispatch({
        type: USER_REGISTER_REQUEST,
        payload: {email, password}
    })
    try {
        const {data} = await Axios.post('/api/users/register', {name, surname, email, password, address, phone})
        dispatch({
